...
<head>
    <meta charset="UTF-8">
    <title>My Grades - TechGenius Academy</title>
    <!-- Bootstrap CSS -->
    ...
    <style>
        ...
        .graded-assignments th, .graded-assignments td {
            border: 1px solid #ddd;
            padding: 10px;
        }
        .graded-assignments th {
            background-color: rgba(0, 105, 217, 0.9);
            color: #fff;
        }
        .graded-assignments tr:nth-child(even) {
            background-color: #f9f9f9;
        }
        .graded-assignments tr:hover {
...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="grades.php"><i class="fas fa-chart-line"></i> My Grades</a>
            </li>
        </ul>
    ...
    <div class="main-content">
        ...
        <div class="graded-assignments">
            ...
            <?php
            // Query to retrieve graded assignments for the current student
            $studentID = $_SESSION['studentID'];
            $query = "SELECT * FROM submissions WHERE studentID = ? AND marksObtained IS NOT NULL";
            $stmt = $conn->prepare($query);
            ...
            if ($result && $result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    $assignmentName = basename($filePath);
                    echo "<tr>";
                    echo "<td>" . htmlspecialchars($submissionID) . "</td>";
                    ...
                    echo "<td>" . htmlspecialchars($marksObtained) . "</td>";
                    echo "<td>" . htmlspecialchars($feedback) . "</td>";
                ...
                echo "<p>No graded assignments found.</p>";
            }
            $stmt->close();
            $conn->close();
            ?>
