...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    if (isset($_GET['studentID']) && !empty($_GET['studentID']) && filter_var($_GET['studentID'], FILTER_VALIDATE_INT)) {
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['studentID']) && !empty($_POST['studentID']) && filter_var($_POST['studentID'], FILTER_VALIDATE_INT)) {
        ...
        $query = "UPDATE students SET studentName = ?, studentSurname = ?, email = ?, password = ?, enrollmentDate = ?, role = ? WHERE studentID = ?";
        $stmt = $conn->prepare($query);
        $stmt->bind_param("ssssssi", $studentName, $studentSurname, $email, $hashed_password, $enrollmentDate, $role, $studentID);
        $stmt->execute();
...
<head>
    <meta charset="UTF-8">
    <title>Update Student - TechGenius Academy</title>
    <!-- Bootstrap CSS -->
        ...
        <div class="form-container">
            ...
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="studentName" name="studentName" class="form-control" value="<?php echo htmlspecialchars($student['studentName']); ?>" required>
                </div>
                <div class="form-group">
                    <label for="studentSurname">Surname:</label>
                    <input type="text" id="studentSurname" name="studentSurname" class="form-control" value="<?php echo htmlspecialchars($student['studentSurname']); ?>" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <!-- Note: For security, consider not showing the password. Alternatively, provide a way to reset it. -->
                    <input type="text" id="password" name="password" class="form-control" value="<?php echo htmlspecialchars($student['password']); ?>" required>
                </div>
                <div class="form-group">
                    <label for="enrollmentDate">Enrollment Date:</label>
                    <input type="date" id="enrollmentDate" name="enrollmentDate" class="form-control" value="<?php echo htmlspecialchars($student['enrollmentDate']); ?>" required>
                </div>
                <div class="form-group">
                    <label for="role">Role:</label>
                    <input type="text" id="role" name="role" class="form-control" value="<?php echo htmlspecialchars($student['role']); ?>" required>
                </div>
