...
if (isset($teacher_id) && !empty($teacher_id)) {
    ...
    if (isset($assignment_id) && !empty($assignment_id)) {
        ...
        $error_message = "Assignment ID is not set or is empty.";
    }
} else {
...
<head>
    <meta charset="UTF-8">
    <title>Update Assignment - TechGenius Academy</title>
    <!-- Bootstrap CSS -->
        ...
        <div class="assignment-form">
            ...
            <form method="post">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="courseID" name="courseID" value="<?php echo htmlspecialchars($assignment['courseID']); ?>" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="totalMarks" name="totalMarks" value="<?php echo htmlspecialchars($assignment['totalMarks']); ?>" required>
                </div>
                <button type="submit" class="btn btn-primary mt-3">Update Assignment</button>
            </form>
            <?php else: ?>
                <div class="alert alert-danger">Assignment not found or you do not have permission to edit this assignment.</div>
            <?php endif; ?>
        </div>
        <!-- Footer -->
        <footer>
            ...
            <div class="footer-logo">
                <img src="small-logo.png" alt="School Logo">
            </div>
